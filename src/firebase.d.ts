// Definición de tipos para el objeto de configuración de Firebase
...
// Definición de tipos para el objeto de inicialización de Firebase
...
export { FirebaseConfig, FirebaseApp, firebase }
